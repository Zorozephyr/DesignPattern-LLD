...
import org.example.designpatterns.observerpattern.observable.StockServer;

import org.example.designpatterns.observerpattern.observer.StockObserver;
import org.example.designpatterns.observerpattern.observer.WebDashboard;
